...
| [Patent 4: Bidirectional Equivalence Architecture for Data Description and Manipulation](专利4_双向对等架构_EN.md) | NDData↔TCL/TQL Bidirectional Equivalence |
...
| [Patent Summary: Common Technical Foundation](专利汇总_共同技术根基_EN.md) | Technical Foundation Overview and Dependency Relations |

## Technical Foundation

```
NDData + TCL/TQL + Agent优先 + TD+ND+DD Three-Layer Penetration
```

This paradigm has been independently verified in 4 projects:
...
Based on the DD Penetration Design, the original TD+ND two-layer fusion extends to TD+ND+DD three-layer fusion:
